...
public struct InfrequentMenstrualCycles: HKCategoryEmptySample {

    public static let categoryTypeIdentifier: HKCategoryTypeIdentifier = .infrequentMenstrualCycles
